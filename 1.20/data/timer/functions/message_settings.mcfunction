...
tellraw @a ["","[",{"text":"Countdown","bold":true,"color":"gray","clickEvent":{"action":"run_command","value":"/trigger timer_trigger set 25"}},{"text":"]"}]
tellraw @p ["",{"text":"["},{"text":"Help","bold":true,"italic":true,"color":"yellow","clickEvent":{"action":"run_command","value":"/trigger timer_trigger set 47"}},{"text":"]"}]
tellraw @a {"text":"-----------------","bold":true}
