...
tellraw @a ["",{"text":"[","color":"white"},{"text":"Start Normal Mode","bold":true,"italic":true,"color":"green","clickEvent":{"action":"run_command","value":"/trigger timer_trigger set 3"}},{"text":"]","color":"white"}]
tellraw @a ["",{"text":"[","color":"white"},{"text":"Start Speedrun Mode","bold":true,"italic":true,"color":"gold","clickEvent":{"action":"run_command","value":"/trigger timer_trigger set 5"}},{"text":"]","color":"white"}]
...
tellraw @a ["","[",{"text":"Reset Timer","bold":true,"italic":true,"color":"red","clickEvent":{"action":"run_command","value":"/trigger timer_trigger set 70"}},"]"]
tellraw @a {"text":" "}
