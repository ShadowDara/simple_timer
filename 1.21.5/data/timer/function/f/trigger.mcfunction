...
execute as @a[scores={timer_trigger=3}] run scoreboard players set start runtime 1
execute as @a[scores={timer_trigger=4}] run scoreboard players set start runtime 0
execute as @a[scores={timer_trigger=5}] run scoreboard players set start runtime 2
...
execute as @a[scores={timer_trigger=46}] run function timer:uninstall/2_unistall
...
execute as @a[scores={timer_trigger=70}] run function timer:starttimer
